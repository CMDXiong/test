...
AddShapeCommand::AddShapeCommand(COptimaskView *doc, const ItemShape &shape, QUndoCommand *parent)
    : QUndoCommand(parent)
{
    m_doc = doc;
    m_shape = shape;
...
RemoveShapeCommand::RemoveShapeCommand(COptimaskView *doc, const QString &shapeName,
                                        QUndoCommand *parent)
    : QUndoCommand(parent)
{
...
SetShapeRectCommand::SetShapeRectCommand(COptimaskView *doc, const QString &shapeName,
