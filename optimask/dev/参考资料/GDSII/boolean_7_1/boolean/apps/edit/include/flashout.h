...
#ifndef _FLASH_OUTDRIVER
#define _FLASH_OUTDRIVER
...
*/
class FLASH_driver_out: public Driver_out
{
	public:
		FLASH_driver_out(const wxString& _filename, bool only_visible=false);
		~FLASH_driver_out();
	...
	private:
      ...
      //! the filename
		wxString	FLASH_out_filename;
  		//! the output stream
		std::ofstream	FLASH_out_file;
      ...
      //! prior to stuffing it in the file
		int 	Xpos;
      //! to store the calculated Flash
      //! prior to stuffing it in the file
		int 	Ypos;
