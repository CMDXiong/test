...
#include "../../src/Item/penwidget.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PenWidget_t, stringdata) + ofs \
...
void PenWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PenWidget::*_t)(const QPen & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PenWidget::penChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PenWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PenWidget.data,
      qt_meta_data_PenWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PenWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PenWidget.stringdata))
