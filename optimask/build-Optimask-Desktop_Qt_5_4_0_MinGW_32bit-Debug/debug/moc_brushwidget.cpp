...
#include "../../src/Item/brushwidget.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BrushWidget_t, stringdata) + ofs \
...
void BrushWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (BrushWidget::*_t)(const QBrush & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BrushWidget::brushChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject BrushWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BrushWidget.data,
      qt_meta_data_BrushWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BrushWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BrushWidget.stringdata))
