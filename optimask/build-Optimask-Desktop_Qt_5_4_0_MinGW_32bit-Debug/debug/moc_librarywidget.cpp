...
#include "../../src/Draw/librarywidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LibraryWidget_t, stringdata) + ofs \
...
const QMetaObject LibraryWidget::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_LibraryWidget.data,
      qt_meta_data_LibraryWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LibraryWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LibraryWidget.stringdata))
