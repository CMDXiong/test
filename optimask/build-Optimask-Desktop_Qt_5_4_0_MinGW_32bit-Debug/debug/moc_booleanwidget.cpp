/****************************************************************************
** Meta object code from reading C++ file 'booleanwidget.h'
**
...
#include "../../src/Alter/booleanwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'booleanwidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BooleanWidget_t, stringdata) + ofs \
...
const QMetaObject BooleanWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BooleanWidget.data,
      qt_meta_data_BooleanWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BooleanWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BooleanWidget.stringdata))
